  ...
  return (
    <section className="flex min-h-[calc(100vh-12rem)] flex-1 flex-col items-center justify-center px-5 py-12 text-center md:px-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl md:text-5xl">
        Hôm nay muốn nghiên cứu gì?
      </h1>
      <p className="mt-5 max-w-2xl text-[15px] leading-7 text-muted-foreground md:text-[17px]">
        Nhập một mã, một câu hỏi về thị trường, hoặc để PanWatch soi danh mục của bạn. Trợ lý sẽ tra dữ liệu sẵn có trước, rồi mới đưa kết luận có căn cứ.
      </p>
      ...
      >
        ...
        <input
          ...
          placeholder="Tìm mã, hoặc hỏi: danh mục của tôi rủi ro tới đâu?"
          aria-label="Mở một nghiên cứu"
        />
        <button
          type="submit"
          ...
          aria-label="Gửi câu hỏi nghiên cứu"
        >
      ...
      <div className="mt-16 grid w-full max-w-3xl gap-3 text-left sm:grid-cols-3">
        {[
          ...
          ['03', 'Bắt đầu từ một câu hỏi', 'Để trợ lý xâu chuỗi bảng giá, đồ thị nến và tin tức, rồi chỉ hướng nghiên cứu tiếp theo.'],
