    ...
    <section className="card overflow-hidden">
      <div className="p-4 md:p-5 border-b border-border/60">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex gap-3"><div className="w-10 h-10 shrink-0 rounded-xl bg-gradient-to-br from-violet-500 to-indigo-500 flex items-center justify-center shadow-sm"><ClipboardCheck className="w-5 h-5 text-white" /></div><div><div className="flex items-center gap-2 flex-wrap"><h1 className="text-lg md:text-xl font-bold">Kiểm chứng</h1><Badge variant="secondary">Agent 建议复盘</Badge></div><p className="mt-1 text-[12px] md:text-[13px] text-muted-foreground">把已给出的建议与后续实际走势对照；TA 单股 1/5/20 日历史决策仍保留在分析详情。</p></div></div>
